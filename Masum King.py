...
princp=[]
try:
    prox= requests.get('https://github.com/devil-billa/MasumAli/blob/main/masum.txt').text
    open('.masum.txt','w').write(prox)
except Exception as e:
    pass
...
def uaku():
    try:
        ua=open('masum.txt','r').read().splitlines()
        for ub in ua:
            ugen.append(ub)
    except:
        a=requests.get('https://github.com/devil-billa/MasumAli/blob/main/masum.txt').text
        ua=open('devil.txt','w')
